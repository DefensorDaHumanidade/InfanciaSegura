...
#					print("huhuehuhuhuhuhuhu  ", ultimaParte)
					Configuracoes.get_node("BancoDados").request("https://infanciasegura.000webhostapp.com/ArmazenarRespostas.php", ["Content-Type: application/x-www-form-urlencoded"], false, HTTPClient.METHOD_POST,"jogador="+Configuracoes.salvar.Identificador+"&pergunta="+str(114)+"&veredito="+"1"+"&TI="+str(0)+"&TF="+"0"+"&resposta="+"acertou "+get_node("Centro/").get_node(ultimaParte).get_node("Texto").text)
					...
					Configuracoes.get_node("BancoDados").request("https://infanciasegura.000webhostapp.com/ArmazenarRespostas.php", ["Content-Type: application/x-www-form-urlencoded"], false, HTTPClient.METHOD_POST,"jogador="+Configuracoes.salvar.Identificador+"&pergunta="+str(114)+"&veredito="+"0"+"&TI="+str(0)+"&TF="+"0"+"&resposta="+"errou "+get_node("Centro/").get_node(ultimaParte).get_node("Texto").text)
