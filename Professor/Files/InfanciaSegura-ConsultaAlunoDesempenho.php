<?php
    ...
    $consultaSQL = "SELECT * FROM Desempenho WHERE Aluno='$IdAluno[0]'";
    $resultado=mysqli_query($conexao, $consultaSQL) or die("Erro 404. Falha ao realizar a consulta SQL.");
    ini_set ('default_charset', 'UTF8');
    ...
    while($dados = mysqli_fetch_array($resultado)){
        echo $dados['Tipo'] . "<br>";
        echo $dados['Fase'] . "<br>";
        echo $dados['Dificuldade'] . "<br>";
        echo $dados['Descricao'] . "<br>";
        echo $dados['Pontuacao'] . "<br>";
        echo $dados['Visualizacao'] . "<br>";
        echo $dados['UltimoJogo'] . "<br>";
    }
